...
-(nonnull instancetype)initWithName:(nonnull NSString *)name identifier:(nullable NSString *)identifier abilities:(nullable NSArray *)abilities sprite:(nullable NSString *)sprite;
